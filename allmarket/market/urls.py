...
from market.views.products import index_view, category_edit_view, category_view, delete_product, product_edit_view, product_view, add_category_view, add_product_view, categories_view, delete_category
